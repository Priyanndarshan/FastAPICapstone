...
// Depends on: api/categories (backend), types (Category), utils/parseApiError, useAsyncState.
...
export function useCategories() {
    // Holds categories array + loading/error; run() for async ops, setData() to update list after mutations.
